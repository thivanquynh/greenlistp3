 ...
 * @param idObjet id de l'objet recherch�
 */
	@Override
	 ...
	 * @param utilisateur le propri�taire des objets recherch�s
	 */
...
/**
 * Methode pour rechercher les objets aillant un libell� ressemblant � une chaine de caractere
